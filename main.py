...
st.set_page_config(page_title="Exchange Rates Analysis", layout="wide")

st.markdown("<h1 style='text-align: center; color: #2E86C1;'>Exchange Rates Analysis (2000-2025)</h1>", unsafe_allow_html=True)
